    ...
    <>
      ...
      >
        ...
        <div className="flex items-center h-16 px-3 border-b border-slate-100 flex-shrink-0">
          {/* Logo pill */}
          <div className={`h-9 w-9 rounded-xl overflow-hidden flex-shrink-0 shadow-sm`}>
            <img src="/logo.png" alt="MedChain" className="h-full w-full object-contain" />
          </div>
        ...
        <div className="border-t border-slate-100 p-3 flex-shrink-0">
          <div className={[
            ...
            <div className={[
              ...
              <p className="text-xs text-slate-300 font-mono truncate select-all" title="Your User ID">ID: {user.id}</p>
            </div>
          </div>
